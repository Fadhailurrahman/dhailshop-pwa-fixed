...
export default class ShopPage {
    ...
    return `
      <section class="container page-transition" id="shop-page">
        ...
        <div style="text-align:center; margin-bottom:20px;">
          <button id="btn-add-story" style="background:#1e3a8a; color:#fff; padding:12px 28px; border:none; border-radius:8px; cursor:pointer; font-weight:600; font-size:1rem;">
            + Tambah Produk
          </button>
        </div>
        ...
        <div id="products-container" style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px, 1fr)); gap:20px; justify-content:center; margin-top:10px;"></div>
      </section>
    `;
  }
  ...
  async afterRender() {
    ...
    addBtn.addEventListener('click', () => window.location.hash = '#/shop/add');
